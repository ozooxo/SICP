...
(define p1 (make-polynomial 'x (list (list 100 (make-real 1)) (list 2 (make-real 2)) (list 0 (make-real 1)))))
(define p2 (make-polynomial 'x (list (list 3 (make-real 3)) (list 2 (make-real 5)))))
...
;Exercise 2.88
;(neg (make-real 2.3)) ;'(real . -2.3)
(neg p1) ;'(polynomial x (100 (real . -1)) (2 (real . -2)) (0 (real . -1)))
(sub p1 p2) ;'(polynomial x (100 (real . 1)) (3 (real . -3)) (2 (real . -3)) (0 (real . 1)))
(sub p3 p4) ;okay